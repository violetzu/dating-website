...
const State_Function = createContext();

// wrapper for context, usually calls XXXContextProvider(State_FunctionProvider)
// but just a domian which allows its child component access things from it
const Global_Domain = ({ children }) => {
    ...
    const state_function = {
        navigate: navigate,
        thisUsername: thisUsername, setThisUsername: setThisUsername,
        currentViewUsername: currentViewUsername, setCurrentViewUsername: setCurrentViewUsername,
        posts: posts, setPosts: setPosts,
        userBio: userBio, setUserBio: setUserBio,
        userTags: userTags, setUserTags: setUserTags,
        ...
        ytURL_sharedPost: ytURL_sharedPost, setytURL_sharedPost: setytURL_sharedPost,
    ...
    return (
        <State_Function.Provider value={state_function}>
            {children}
        </State_Function.Provider>
    );
};

export { State_Function, Global_Domain };